        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-8 text-xl leading-8 text-gray-600 max-w-3xl mx-auto">
              ...
              Your documents never leave your device. Zero cloud processing. HIPAA-friendly by
              design.
            </p>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Your documents never leave your device. All processing happens entirely in your
                  browser using WebAssembly and JavaScript.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Smart pattern matching finds SSNs, phone numbers, emails, credit cards, dates of
                  birth, and more with high accuracy.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  No data transmission means built-in compliance with HIPAA, GDPR, and other privacy
                  regulations.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Process documents in seconds with optimized algorithms. No waiting for uploads or
                  server processing.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Progressive Web App technology means you can install and use RedactGuide
                  completely offline.
                </p>
              </div>
              ...
              <div className="relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  No subscriptions, no credits, no hidden costs. RedactGuide is completely free and
                  open source.
                </p>
              </div>
            </div>
